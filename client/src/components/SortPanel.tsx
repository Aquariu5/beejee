  ...
  return (
    <Grid container direction={'column'} gap={2}>
      <FormControl fullWidth>
        ...
        <Select value={dataStore.sorBy} label="Сортировать по" onChange={changeSortBy}>
      ...
      <FormControl fullWidth>
        ...
        <Select value={dataStore.sortDirection} label="Сортировать по" onChange={changeDirection}>
